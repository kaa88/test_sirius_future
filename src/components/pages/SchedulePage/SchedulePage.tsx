...
export const SchedulePage = ({
  ...
  return (
    <div className={cn([className, styles._])} {...props}>
      Main page
      <Button variant="default" disabled={dis}>
        button button button
      </Button>
      <Button variant="dark" disabled={dis}>
        button button button
      </Button>
      <Button variant="light" disabled={dis}>
        button button button
      </Button>
      <Button variant="green" disabled={dis} size="small">
        button button button
      </Button>
      <Button variant="dashed" disabled={dis} size="large">
        button button button
      </Button>
      <button onClick={() => setDis(!dis)}>switch</button>
      <IconList />
    </div>
  );
};
